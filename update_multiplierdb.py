...
#                                                                              #
#                                                         ::::::::             #
#    update_multiplierdb.py                             :+:    :+:             #
#                                                      +:+                     #
#    By: tbruinem <tbruinem@student.codam.nl>         +#+                      #
#                                                    +#+                       #
#    Created: 2021/01/03 15:09:01 by tbruinem      #+#    #+#                  #
#    Updated: 2021/01/03 15:10:15 by tbruinem      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #

import pickle

multiplierdb = {	'normal': {'normal': 1, 'fighting': 1, 'flying': 1, 'poison': 1, 'ground': 1, 'rock': 0.5, 'bug': 1, 'ghost': 0, 'steel': 0.5, 'fire': 1, 'water': 1, 'grass': 1, 'electric': 1, 'psychic': 1, 'ice': 1, 'dragon': 1, 'dark': 1, 'fairy': 1},
...
with open('multiplierdb', 'wb') as f:
	pickle.dump(multiplierdb, f, pickle.HIGHEST_PROTOCOL)

print("PokemonVortex multiplier database succesfully updated!, saved under 'multiplierdb'")